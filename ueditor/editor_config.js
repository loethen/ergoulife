...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","insertimage","map","blockquote","highlightcode","bold","underline","forecolor","justifyleft","justifycenter","removeformat","imageleft","imageright","imagecenter","inserttable"]]
